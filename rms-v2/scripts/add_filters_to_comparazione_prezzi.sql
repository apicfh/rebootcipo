-- Aggiorna la funzione RPC per includere filtri paxmax e livello
...
BEGIN
  ...
  prezzi_per_settimana AS (
    -- Aggiunto JOIN con tipi_camere per accedere a paxmax e livello
    ...
    WHERE pf.valido_da <= data_partenza_param
      ...
      -- Aggiunto filtri condizionali per paxmax e livello
