-- Prima elimino la funzione esistente
...
-- Ricreo la funzione con la firma corretta
...
BEGIN
  ...
  -- Recupera le date della settimana
  SELECT inizio, fine INTO settimana_inizio, settimana_fine
  FROM settimane_soggiorno
  WHERE id = settimana_id_param;
