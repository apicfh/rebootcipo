...
CREATE OR REPLACE FUNCTION public.provvisorio_domanda(
...
BEGIN
  ...
  -- Restituisci i dati dalla tabella provvisorio_domanda
  RETURN QUERY
...
GRANT EXECUTE ON FUNCTION public.provvisorio_domanda(date, date) TO authenticated;
GRANT EXECUTE ON FUNCTION public.provvisorio_domanda(date, date) TO service_role;
